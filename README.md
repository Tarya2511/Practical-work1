...
Данный проект представляет собой практическую работу по созданию шпаргалки в рамках курса по основам Git. Шпаргалка включает в себя список основных команд Git.
